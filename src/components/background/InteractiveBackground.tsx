...
const InteractiveBackground: React.FC<InteractiveBackgroundProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden">
      ...
      {/* Statistics panel */}
      <div className="absolute top-20 right-4 w-72 p-4 bg-white/10 dark:bg-gray-900/20 backdrop-blur-md rounded-xl border border-white/20 dark:border-gray-700/30">
